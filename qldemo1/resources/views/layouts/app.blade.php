...
<body class="sidebar-collapsed">
  ...
  <div class="d-flex app-wrap">
    ...
    <main class="flex-grow-1 d-flex flex-column">
      ...
      <section class="p-4 flex-grow-1">
        {{-- ❌ BỎ alert success cũ (đổi sang toast) --}}
        {{-- @if(session('ok')) <div class="alert alert-success">{{ session('ok') }}
  </div> @endif --}}

  {{-- ❌ BỎ alert error chung nếu bạn muốn lỗi cũng bằng toast --}}
  {{-- (Nếu vẫn muốn giữ lỗi dạng bảng đỏ thì giữ lại block này) --}}
  {{--
  ...
  {{-- ✅ Load toast.js global --}}
  <script src="{{ asset('js/toast.js') }}"></script>

  {{-- ✅ Bắn toast từ session/validation (global, mọi trang đều dùng) --}}
  <script>
