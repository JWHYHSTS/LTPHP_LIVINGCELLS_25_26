...
Route::prefix('doantruong')
    ...
    ->group(function () {
        ...
        Route::post('/sukien/toggle',      [DoanController::class, 'suKienToggle'])->name('sukien.toggle'); // mở/đóng

        // ===== DS ĐĂNG KÝ SỰ KIỆN + ĐIỂM DANH =====
        Route::get('/sukien/dangky',       [DoanController::class, 'suKienDangKyIndex'])->name('sukien.dangky.index');
        Route::post('/sukien/diemdanh',    [DoanController::class, 'suKienDiemDanh'])->name('sukien.diemdanh'); // điểm danh/hủy điểm danh
    });
